...
const range = function(count, skipZero = false, descending = false) {
  ...
  if (count === 0) {
    ...
    return result;
  } else if (skipZero === false && descending === false) {
    for (let i = 0; i < count; i++) {
      result.push(i);
    }
    return result;
  } else if (skipZero === true && descending === false) {
    for (let i = 1; i <= count; i++) {
      result.push(i);
    }
    return result;
  } else if (skipZero === true && descending === true) {
    for (let i = count; i > 0; i--) {
      result.push(i);
    }
    return result;
  } else if (skipZero === false && descending === true) {
